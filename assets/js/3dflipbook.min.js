!function (modules) {
    ...
    var _$ = window.jQuery, _html2canvas = window.html2canvas, _THREE = window.THREE, _React = window.React,
        _ReactDOM = window.ReactDOM, _PDFJS = window.PDFJS, _tr = function (s) {
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _$ = window.jQuery, _html2canvas = window.html2canvas, _THREE = window.THREE, _PDFJS = window.PDFJS,
        _tr = function (s) {
            return (window.iberezansky || {}).tr && window.iberezansky.tr(s) || s
        };
    ...
    var BaseMathUtils = function () {
        ...
        return BaseMathUtils.sum1 = function (ka, a, kb, b) {
            ...
            var sum = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : BaseMathUtils.sum[y.length - 1],
                k1 = dy(t, y), k2 = dy(t + dt / 2, sum(1, y, dt / 2, k1)), k3 = dy(t + dt / 2, sum(1, y, dt / 2, k2)),
            ...
            var r = [], l = data.length, D = BaseMathUtils.disp(data);
            if (D < l && l > 1) {
            ...
            if (Math.abs(d) > BaseMathUtils.eps) {
                var dx = BaseMathUtils.det2(b1, a1[1], b2, a2[1]), dy = BaseMathUtils.det2(a1[0], b1, a2[0], b2);
                res = {x: dx / d, y: dy / d}
            }
            return res
            ...
            for (; !done;) {
                ...
                for (var np = {x: p.x + Math.random() - .5, y: p.y + Math.random() - .5}, rn = {
                    ...
                    var p0 = ps[_i4], p1 = ps[(_i4 + 1) % ps.length], n = {x: p1.x - p0.x, y: p1.y - p0.y},
                        a2 = [n.y, -n.x], b2 = p0.x * n.y - p0.y * n.x, ip = BaseMathUtils.solve2Lin(a1, b1, a2, b2);
                    if (ip) {
            ...
            for (var sg = [0, 0], i = 0; i < ps.length; ++i) {
                var p0 = ps[i], p1 = ps[(i + 1) % ps.length], a = {x: p0.x - p.x, y: p0.y - p.y},
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _BaseMathUtils2 = __webpack_require__(2),
        _BaseMathUtils3 = _interopRequireDefault(_BaseMathUtils2), MathUtils = function (_BaseMathUtils) {
            function MathUtils() {
            ...
            return _inherits(MathUtils, _BaseMathUtils), MathUtils.splitSpline = function (spline, N) {
                ...
                for (var res = [], i = 0; i < poly.length; ++i) {
                    var p0 = poly[i], p1 = poly[(i + 1) % poly.length], l = _BaseMathUtils3.default.v2dist(p0, p1),
                        n = Math.ceil(l / maxDl), dl = l / n;
                    res.push(p0);
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _GraphUtils = __webpack_require__(7),
        _GraphUtils2 = _interopRequireDefault(_GraphUtils), ImageBase = function () {
    ...
    var _extends = Object.assign || function (target) {
        ...
        return EventConverter.prototype.setEnable = function (vl) {
            ...
            if (callback) {
                var props = _extends({}, e, {type: type, view: this.wnd}), jE = _libs.$.Event(type, props);
                callback(jE, object)
            }
    ...
    var GraphUtils = function () {
        ...
        return GraphUtils.extrapolateLinear = function (x, y, xi) {
            ...
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1,
                bs = GraphUtils.getColorBytes(color), ibs = [255 - bs[0], 255 - bs[1], 255 - bs[2]],
    ...
    exports.__esModule = !0;
    var _Cache = __webpack_require__(14), _Cache2 = _interopRequireDefault(_Cache),
        _BlankImage = __webpack_require__(43), _BlankImage2 = _interopRequireDefault(_BlankImage),
        _StaticImage = __webpack_require__(59), _StaticImage2 = _interopRequireDefault(_StaticImage),
        _PdfImage = __webpack_require__(57), _PdfImage2 = _interopRequireDefault(_PdfImage),
        _InteractiveImage = __webpack_require__(51), _InteractiveImage2 = _interopRequireDefault(_InteractiveImage),
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _book = __webpack_require__(11), _BaseMathUtils = __webpack_require__(2),
        _BaseMathUtils2 = _interopRequireDefault(_BaseMathUtils), BookPropsBuilder = function () {
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) {
            ...
            return target
        }, _libs = __webpack_require__(1), _sheetBlock = __webpack_require__(41),
        _sheetBlock2 = _interopRequireDefault(_sheetBlock), _MathUtils = __webpack_require__(3),
        _MathUtils2 = _interopRequireDefault(_MathUtils), _ThreeUtils = __webpack_require__(20),
        _ThreeUtils2 = _interopRequireDefault(_ThreeUtils), SheetBlock = function () {
            function SheetBlock(visual, p, first, last) {
                var angle = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0, _this = this,
            ...
            return SheetBlock.prototype.dispose = function () {
                ...
                var state = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.state,
                    ...
                    last = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : this.p.last, PI = Math.PI;
                this.state = state;
                ...
                var inAngle = this.angle > PI / 2 ? PI - this.angle : this.angle,
                    ...
                    left = _getPointsAtAngleAndH[0], right = _getPointsAtAngleAndH[1];
                ...
                if (i !== this.geometry.vertices.length && console.warn("setPoints: bad mapping!"), this.corner.use && !this.corner.points.length) {
                    var plane = new _libs.THREE.Plane, normal = plane.normal,
                ...
                var bl = _MathUtils2.default.splitSpline(this.pSpline, N), r = [],
                    p1 = _extends({}, this.pSpline.getPoint((N - 1) / N)), p2 = _extends({}, this.pSpline.getPoint(1)),
                ...
                sp.set(sp.x + .1 * dp.x / ln, sp.y + .1 * dp.y / ln, 0), bl = _MathUtils2.default.splitSpline(this.pSpline, N), bl.ls.push(1e7), _MathUtils2.default.mapl2L(bl.ls, bl.len, _sheetBlock2.default.resX, function (i) {
                    for (var j = 0; j < hs.length; ++j) if (i) {
                        var p0 = _extends({}, _this3.pSpline.getPoint((i - 1) / N)), _p = _this3.pSpline.getPoint(i / N),
                            x = -(_p.y - p0.y), y = _p.x - p0.x, l = Math.sqrt(x * x + y * y);
                ...
                var openedInterpolationIndeces = [[2, 3, 4], [2, 3, 4, 5, 6]],
                    closedInterpolationIndeces = [[0, 1, 2], [0, 1, 2]], flatInterpolationIndeces = [[5, 4], [7, 6]],
                    interpolationPoints = [{
    ...
    function props() {
        return {
            ...
            cover: {binderTexture: "", depth: 3e-4, padding: 0, mass: .003},
    ...
    _libs.THREE.CSS3DObject = function (_THREE$Object3D) {
        ...
        var _width, _height, _widthHalf, _heightHalf, matrix = new _libs.THREE.Matrix4,
            cache = {camera: {fov: 0, style: ""}, objects: {}}, domElement = document.createElement("div");
    ...
    exports.__esModule = !0;
    var _EventConverter2 = __webpack_require__(6), _EventConverter3 = _interopRequireDefault(_EventConverter2),
    ...
    var _extends = Object.assign || function (target) {
        ...
        return target
    }, _Utils = __webpack_require__(4), _Utils2 = _interopRequireDefault(_Utils), Finder = function () {
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _Utils = __webpack_require__(4), _Utils2 = _interopRequireDefault(_Utils);
    ...
    exports.__esModule = !0;
    var _BaseMathUtils = __webpack_require__(2), _BaseMathUtils2 = _interopRequireDefault(_BaseMathUtils),
        ThreeUtils = function () {
            function ThreeUtils() {
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _libs = __webpack_require__(1), _Detector = __webpack_require__(45),
        _Detector2 = _interopRequireDefault(_Detector), _VisualWorld = __webpack_require__(66),
        _VisualWorld2 = _interopRequireDefault(_VisualWorld), _PdfLinksHandler = __webpack_require__(35),
        _PdfLinksHandler2 = _interopRequireDefault(_PdfLinksHandler), _Book = __webpack_require__(26),
        _Book2 = _interopRequireDefault(_Book), _BookView = __webpack_require__(29),
        _BookView2 = _interopRequireDefault(_BookView), _BookController = __webpack_require__(27),
        _BookController2 = _interopRequireDefault(_BookController), _PdfBookPropsBuilder = __webpack_require__(34),
        ...
        _LoadingController = __webpack_require__(53), _LoadingController2 = _interopRequireDefault(_LoadingController),
        _Search = __webpack_require__(58), _Search2 = _interopRequireDefault(_Search),
        _Bookmarks = __webpack_require__(44), _Bookmarks2 = _interopRequireDefault(_Bookmarks),
        _Thumbnails = __webpack_require__(63), _Thumbnails2 = _interopRequireDefault(_Thumbnails),
        _TocController = __webpack_require__(40), _TocController2 = _interopRequireDefault(_TocController),
        _BookPrinter = __webpack_require__(28), _BookPrinter2 = _interopRequireDefault(_BookPrinter),
        _AutoNavigator = __webpack_require__(24), _AutoNavigator2 = _interopRequireDefault(_AutoNavigator),
        _SoundsEnviroment = __webpack_require__(39), _SoundsEnviroment2 = _interopRequireDefault(_SoundsEnviroment);
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _libs = __webpack_require__(1), _book = __webpack_require__(11), _GraphUtils = __webpack_require__(7),
        _GraphUtils2 = _interopRequireDefault(_GraphUtils), _Binder = __webpack_require__(25),
        _Binder2 = _interopRequireDefault(_Binder), _Cover = __webpack_require__(31),
        _Cover2 = _interopRequireDefault(_Cover), _SheetBlock = __webpack_require__(10),
        _SheetBlock2 = _interopRequireDefault(_SheetBlock), _SheetPhysics = __webpack_require__(38),
        _SheetPhysics2 = _interopRequireDefault(_SheetPhysics), _PageManager = __webpack_require__(33),
        _PageManager2 = _interopRequireDefault(_PageManager), _CSSLayer = __webpack_require__(13),
        _CSSLayer2 = _interopRequireDefault(_CSSLayer), _CssLayersManager = __webpack_require__(32),
        _CssLayersManager2 = _interopRequireDefault(_CssLayersManager), _SearchEngine = __webpack_require__(36),
        _SearchEngine2 = _interopRequireDefault(_SearchEngine), _CustomEventConverter = __webpack_require__(16),
        _CustomEventConverter2 = _interopRequireDefault(_CustomEventConverter), _CircleTarget = __webpack_require__(68),
        _CircleTarget2 = _interopRequireDefault(_CircleTarget), Book = function (_THREE$EventDispatche) {
            function Book(visual, sheets, pageCallback, props) {
                ...
                return sheets = Math.min(3, sheets), visual.jContainer.append('\n      <style type="text/css">\n        .demo-msg {\n          position: absolute;\n          top: 10px;\n          right: 10px;\n          padding: 10px;\n          background-color: #ffe4e1;\n          border-radius: 3px;\n        }\n      </style>\n      <div class="demo-msg">\n        This is the demo version, only 10 pages are available. Use the <a href="http://3dflipbook.net/download-jq" target="_blank">full version</a>.\n      </div>\n    '), _this.visual = visual, _this.mouseController = !0, _this.p = _extends({}, Book.prepareProps(props), {
                    sheets: sheets,
            ...
            return _inherits(Book, _THREE$EventDispatche), Book.prototype.dispose = function () {
                ...
                var block = void 0;
                if (n < 2) block = this.leftCover; else if (n < 2 * (this.p.sheets + 1)) for (var _iterator2 = this.sheetBlocks, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator](); ;) {
                    var _ref2;
                    if (_isArray2) {
                        if (_i2 >= _iterator2.length) break;
                        _ref2 = _iterator2[_i2++]
                ...
                var _this2 = this, size = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1,
                    ...
                    block = void 0, res = void 0;
                return this.sheetPhysics.getSize() < 25 && !function () {
                    var left = _this2.sheetBlocks[0], PI = Math.PI;
                ...
                var _this3 = this, size = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1,
                    ...
                    block = void 0, res = void 0;
                return this.sheetPhysics.getSize() < 25 && !function () {
                    var right = _this3.sheetBlocks[_this3.sheetBlocks.length - 1], PI = Math.PI;
                ...
                var res = !1, block = object.object.userData.self, p = _extends({}, object.uv),
                ...
                this.mouseController && !function () {
                    ...
                    if ("mouseover" === e.type) _this4.hoverInfo && void 0 !== _this4.hoverInfo.pendings ? ++_this4.hoverInfo.pendings : (_this4.hoverInfo && (console.warn("Wrong state: element is already hover"), _this4.hoverInfo.n !== n && _this4.clearHoverInfo()), _this4.hoverInfo || _this4.dragInfo || !function () {
                        var res = Promise.resolve(void 0), hoverAngle = .02, hover = _this4.getBlockByPage(n),
                            possible = _this4.getFlipping(i);
                        if (n > 1 && n < 2 * (_this4.p.sheets + 1) && hover.physicId && (hover.angle < hoverAngle || hover.angle > Math.PI - hoverAngle)) res = Promise.resolve(hover); else if (hover === possible) {
                            var sheetBlocks = [_this4.leftCover].concat(_this4.sheetBlocks, [_this4.rightCover]),
                                j = sheetBlocks.indexOf(hover), nextBlock = ~j ? sheetBlocks[j + 2 * i - 1] : void 0;
                    ...
                    }()); else if (_this4.hoverInfo && "mouseout" === e.type) void 0 !== _this4.hoverInfo.pendings ? --_this4.hoverInfo.pendings : n === _this4.hoverInfo.n && _this4.clearHoverInfo(); else if ("mousedown" === e.type) _this4.cornerClickData = {
                        x: e.pageX,
                        y: e.pageY
                        ...
                        if (Math.sqrt(Math.pow(_this4.cornerClickData.x - e.pageX, 2) + Math.pow(_this4.cornerClickData.y - e.pageY, 2)) < 5) {
                            ...
                            if (hover.physicId) {
                                var id = hover.physicId, props = hover.getProps();
                ...
                var _this5 = this,
                    ...
                    r = .15, target = new _CircleTarget2.default(1 - .5 * r, .5 * r, r);
                ...
                this.animationNotification && (delete this.animationNotification, this.layerManager.show(), this.dispatchEvent({type: "afterAnimation"}))
                ...
                var jC = (0, _libs.$)('<canvas width="8" height="8"></canvas>'), ctx = jC[0].getContext("2d");
                ...
                var p = _extends({}, props, {
                    ...
                    }), scale = 10, height = scale * p.height, width = scale * p.width, flipProgressClb = function () {
                    }, sheet = {sideTexture: p.sheet.sideTexture || Book.createSideTexture(p.sheet.color)},
                    ...
                    }), marker = {use: !1, color: 16711680, size: .001 * scale};
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) {
            ...
            return target
        }, _libs = __webpack_require__(1), _Controller2 = __webpack_require__(15),
        _Controller3 = _interopRequireDefault(_Controller2), _bookController = __webpack_require__(42),
        _EventsToActions = __webpack_require__(49), _EventsToActions2 = _interopRequireDefault(_EventsToActions),
        _stats = __webpack_require__(70), _stats2 = _interopRequireDefault(_stats),
        _Object3DWatcher = __webpack_require__(55), _Object3DWatcher2 = _interopRequireDefault(_Object3DWatcher),
        _FullScreen = __webpack_require__(50), _FullScreen2 = _interopRequireDefault(_FullScreen),
        BookController = function (_Controller) {
            ...
            return _inherits(BookController, _Controller), BookController.prototype.dispose = function () {
                ...
                var target = Math.max(Math.min(page - 1 + page % 2, this.book.getPages() - 1), 0),
                    current = this.book.getPage(), flips = [], covs = 0;
                if (target != current) {
                ...
                }), setClb(flips[1], 500); else for (var time = 0, _iterator2 = flips, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator](); ;) {
                    var _ref2;
                    if (_isArray2) {
                        if (_i2 >= _iterator2.length) break;
                        _ref2 = _iterator2[_i2++]
                ...
                return flipRes ? flipRes.then(function (block) {
                    return block && _this7.dispatchAsync({type: "startFlip"}), block
                ...
                this.viewState = {
                    cmdZoomIn: {enable: this.canZoomIn(), visible: this.actions.cmdZoomIn.enabled, active: !1},
                    cmdZoomOut: {enable: this.canZoomOut(), visible: this.actions.cmdZoomOut.enabled, active: !1},
                    cmdDefaultZoom: {
                    ...
                    cmdSave: {enable: !0, visible: this.actions.cmdSave.enabled && !!this.p.downloadURL, active: !1},
                    cmdPrint: {enable: !0, visible: this.actions.cmdPrint.enabled && !!this.printer, active: !1},
                    cmdFullScreen: {
                    ...
                    widSettings: {enable: !0, visible: this.actions.widSettings.enabled, active: !1},
                    cmdSmartPan: {enable: !0, visible: this.actions.cmdSmartPan.enabled, active: this.state.smartPan},
                    cmdSinglePage: {
                        enable: !0,
                    ...
                    cmdStats: {enable: !0, visible: this.actions.cmdStats.enabled, active: this.state.stats},
                    cmdLightingUp: {
                ...
                var _this8 = this, isSwipping = function (name) {
                ...
                return _extends({}, cmds, {
                    cmdPanLeft: {
                        activate: function (e) {
                            return _this8.orbit.actions.pan(e, {state: "move", dx: -_this8.p.pan.speed, dy: 0})
                        }
                    },
                    cmdPanRight: {
                        activate: function (e) {
                    ...
                    cmdPanUp: {
                        activate: function (e) {
                            return _this8.orbit.actions.pan(e, {state: "move", dx: 0, dy: -_this8.p.pan.speed})
                        }
                    },
                    cmdPanDown: {
                        activate: function (e) {
                    ...
                    touchCmdSwipe: {
                        activate: function (e, data) {
                            if (isSwipping("touchCmdSwipe")) if (e.preventDefault(), "start" === data.state) {
    ...
    var _libs = __webpack_require__(1), BookPrinter = function () {
        ...
        return BookPrinter.prototype.cancel = function () {
            ...
            var isChromium = this.wnd.chrome, winNav = this.wnd.navigator, vendorName = winNav.vendor,
                isIEedge = winNav.userAgent.indexOf("Edge") > -1, isIOSChrome = winNav.userAgent.match("CriOS"),
                use = void 0;
    ...
    exports.__esModule = !0;
    var _View2 = (__webpack_require__(1), __webpack_require__(65)), _View3 = _interopRequireDefault(_View2),
        BookView = function (_View) {
            ...
            return _inherits(BookView, _View), BookView.prototype.initView = function () {
                ...
                var _this2 = this, handlers = void 0;
    ...
    exports.__esModule = !0;
    var _BookPropsBuilder2 = __webpack_require__(9), _BookPropsBuilder3 = _interopRequireDefault(_BookPropsBuilder2),
        _ImageFactory = __webpack_require__(8), _ImageFactory2 = _interopRequireDefault(_ImageFactory),
        ClbBookPropsBuilder = function (_BookPropsBuilder) {
            function ClbBookPropsBuilder(context, pageCallback, pages, onReady) {
                ...
                return _this.calcSheets(pages), _this.pageCallback = pageCallback, _this.binds = {pageCallback: pageCallback.bind(_this)}, _this.imageFactory = new _ImageFactory2.default(context), pages > 0 ? !function () {
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _SheetBlock2 = __webpack_require__(10), _SheetBlock3 = _interopRequireDefault(_SheetBlock2),
        Cover = function (_SheetBlock) {
            ...
            return _inherits(Cover, _SheetBlock), Cover.prototype.getProps = function () {
                ...
                var openedInterpolationIndeces = [[2, 3, 4], [2, 3, 4, 5, 6]],
                    closedInterpolationIndeces = [[0, 1, 2], [0, 1, 2]], interpolationPoints = [{
    ...
    exports.__esModule = !0;
    var _SheetCssLayer = __webpack_require__(37), _SheetCssLayer2 = _interopRequireDefault(_SheetCssLayer),
        CssLayersManager = function () {
            ...
            return CssLayersManager.prototype.getActives = function () {
                var page = this.book.getPage(), pages = this.book.getPages();
                ...
                for (var _loop = function () {
                    ...
                    w ? "ready" === w.state && w.layers.length && !function () {
                        ...
                        var w = _this.wrappers[n] = {state: "loading", layers: []};
                        Promise.resolve().then(function () {
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _libs = __webpack_require__(1), _Cache = __webpack_require__(14), _Cache2 = _interopRequireDefault(_Cache),
        _LoadingAnimation = __webpack_require__(52), _LoadingAnimation2 = _interopRequireDefault(_LoadingAnimation),
        _ImageFactory = __webpack_require__(8), _ImageFactory2 = _interopRequireDefault(_ImageFactory),
        _BaseMathUtils = __webpack_require__(2), _BaseMathUtils2 = _interopRequireDefault(_BaseMathUtils),
        _TextureAnimator = __webpack_require__(60), _TextureAnimator2 = _interopRequireDefault(_TextureAnimator),
        PageManager = function () {
            ...
            return PageManager.prototype.createLoadingTexture = function (p) {
                var spriteTiles = 6, scale = Math.sqrt(1262992.5 / (p.widthTexels * p.heightTexels)),
                ...
                var _this3 = this, pi = this.p.pageCallback(this.rtlPageN(n)),
                    p = this.isCover(n) ? this.p.cover : this.p.page, o = {
                ...
                return o.texture.minFilter = _libs.THREE.LinearFilter, this.loadings.push(o), this.setMaterial(o, material), Promise.resolve().then(function () {
                    if (o.texture) {
                        ...
                        o.wrapper = _this3.imageFactory.build(pi, void 0 === pi.number ? n : pi.number, res.width, res.height, p.color, _this3.p.injector), o.wrapper.setQuery && o.wrapper.setQuery(_this3.pageQuery), o.simulate = pi.interactive ? (o.wrapper.simulate || function () {
                        }).bind(o.wrapper) : void 0, o.wrapper.onLoad = function () {
                            _this3.pushInRenderQueue(o), _this3.book.dispatchEvent({type: "loadedPage", page: n})
    ...
    exports.__esModule = !0;
    var _BookPropsBuilder2 = __webpack_require__(9), _BookPropsBuilder3 = _interopRequireDefault(_BookPropsBuilder2),
        _Pdf = __webpack_require__(18), _Pdf2 = _interopRequireDefault(_Pdf),
    ...
    var _libs = __webpack_require__(1), PdfLinksHandler = function () {
        ...
        return PdfLinksHandler.prototype.dispose = function () {
            ...
            switch (e.type) {
                ...
                case"touchtap":
                case"click":
                    if (anno.url) this.callHandlers("external", anno.url); else if (anno.dest) {
    ...
    exports.__esModule = !0;
    var _Finder = __webpack_require__(17), _Finder2 = _interopRequireDefault(_Finder), SearchEngine = function () {
    ...
    exports.__esModule = !0;
    var _CSSLayer = __webpack_require__(13), _CSSLayer2 = _interopRequireDefault(_CSSLayer),
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _MathUtils = __webpack_require__(3), _MathUtils2 = _interopRequireDefault(_MathUtils),
        SheetPhysics = function () {
            ...
            return SheetPhysics.targetForceClb = function (o, a, v, ch) {
                ...
                if (this.os.length) for (var os = [_extends({}, this.os[0], {
                    l: 0,
                    m: this.p.infM,
                    ch: 0
                    ...
                    var a = os[i - 1], b = os[i], al = a.l + this.p.cornerDeviation * a.ch * this.p.r,
                        bl = b.l + this.p.cornerDeviation * b.ch * this.p.r;
                    if (1.05 * al > bl && a.ch > b.ch) {
                        var dCh = a.ch - b.ch, dv = a.m / a.flbt + b.m / b.flbt, ka = a.m / a.flbt / dv,
                            kb = b.m / b.flbt / dv;
                        a.ch = a.ch - kb * dCh, b.ch = b.ch + ka * dCh
                    }
                }
            }, SheetPhysics.prototype.solveCollision = function (a, b) {
                var mm = b.m + a.m, av = (-a.v * b.m + a.m * a.v + 2 * b.m * b.v) / mm,
                ...
                for (var nos = [], _iterator6 = os, _isArray6 = Array.isArray(_iterator6), _i7 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator](); ;) {
                    ...
                    var o = _ref6, vl = _MathUtils2.default.rk4(this.dy.bind({
                        g: this.p.gravity,
                        r: this.p.r,
                        m: o.m,
                        f: o.f,
    ...
    exports.__esModule = !0;
    var _WidgetController2 = __webpack_require__(67), _WidgetController3 = _interopRequireDefault(_WidgetController2),
        TocController = function (_WidgetController) {
            ...
            return _inherits(TocController, _WidgetController), TocController.prototype.setThumbnails = function (thumbnails) {
                ...
                var _this2 = this;
                if (item.url) window.open(item.url, "_blank"); else if (item.dest) {
                    var destPromise = void 0;
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(1), _ThreeUtils = __webpack_require__(20),
        _ThreeUtils2 = _interopRequireDefault(_ThreeUtils), resX = 11, resY = 2, resZ = 15, scale = 1, faces = [],
    ...
    function props() {
        return {
            eps: 1e-4,
            skin: {default: "short-white-book-view"},
            ...
            actions: {
                cmdZoomIn: {enabled: !0},
                cmdZoomOut: {enabled: !0},
                cmdDefaultZoom: {enabled: !0, type: "dblclick", code: 0},
                cmdToc: {enabled: !0},
                cmdFastBackward: {enabled: !1},
                cmdBackward: {enabled: !0},
                cmdForward: {enabled: !0},
                cmdFastForward: {enabled: !1},
                cmdSave: {enabled: !0},
                cmdPrint: {enabled: !0},
                cmdFullScreen: {enabled: !0},
                widSettings: {enabled: !0},
                cmdSmartPan: {enabled: !0, active: !0},
                cmdSinglePage: {enabled: !0, active: !1, activeForMobile: !1},
                cmdSounds: {enabled: !0, active: !0},
                cmdStats: {enabled: !0, active: !1},
                cmdLightingUp: {enabled: !0},
                cmdLightingDown: {enabled: !0},
    ...
    var _ImageBase2 = (__webpack_require__(0), __webpack_require__(5)),
        _ImageBase3 = _interopRequireDefault(_ImageBase2), BlankImage = function (_ImageBase) {
    ...
    var _libs = __webpack_require__(0), Bookmarks = function () {
        ...
        return Bookmarks.prototype.getSize = function () {
            ...
            var map = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
                level = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0, nodes = null;
    ...
    var _libs = __webpack_require__(0), Detector = function () {
        ...
        return Detector.getWebGLErrorMessage = function () {
            ...
            var parent = void 0, id = void 0, element = void 0;
    ...
    var _libs = __webpack_require__(0), DocMouseSimulator = function () {
        ...
        return DocMouseSimulator.prototype.convertCoords = function (x, y) {
            ...
            var p = this.convertCoords(x, y), element = doc === this.doc ? this.getElement(p) : void 0,
                trigger = void 0 !== element, notify = !1;
            switch (e.type) {
                case"mousedown":
    ...
    var Dom2Image = function Dom2Image(wnd, doc, cache) {
        ...
        function newUtil() {
            function mimes() {
                var WOFF = "application/font-woff", JPEG = "image/jpeg";
                return {
                    woff: WOFF,
                    woff2: WOFF,
        ...
        var util = newUtil(), inliner = newInliner(), fontFaces = newFontFaces(), images = newImages();
    ...
    var EventsToActions = function () {
        ...
        return EventsToActions.getEventFlags = function (e) {
            ...
            }), this.picked = {x: e.pageX, y: e.pageY, actions: this.picked.actions})
            ...
            this.touchPicked = _extends({}, EventsToActions.getPosition(touches), {
                ...
                code: touches.length,
                flags: flags
            }), this.fireActions(this.touchPicked.actions, e, {state: "start"})
    ...
    EventsToActions.modKeys = {Ctrl: 1, Shift: 2, Alt: 4}, EventsToActions.mouseButtons = {
        Left: 0,
        Middle: 1,
        Right: 2
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _ImageBase2 = __webpack_require__(5),
        _ImageBase3 = _interopRequireDefault(_ImageBase2), _BaseMathUtils = __webpack_require__(2),
        _BaseMathUtils2 = _interopRequireDefault(_BaseMathUtils), _Dom2Image = __webpack_require__(47),
        _Dom2Image2 = _interopRequireDefault(_Dom2Image), _DocMouseSimulator = __webpack_require__(46),
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _GraphUtils = __webpack_require__(7),
        _GraphUtils2 = _interopRequireDefault(_GraphUtils), _MathUtils = __webpack_require__(3),
        _MathUtils2 = _interopRequireDefault(_MathUtils), LoadingAnimation = function () {
            ...
            return LoadingAnimation.prototype.dy = function (t, y) {
                ...
                if (this.os = this.integrate(T), this.t += T, this.t >= this.p.updateInterval) {
                    this.t = 0;
                    var r = .06 * Math.min(this.c.width, this.c.height), a = this.os[1], x0 = .5 * this.c.width,
                        y0 = .5 * this.c.height, ctx = this.ctx;
                    ...
                    for (var i = 0, _a = a, _r = .2 * r; i < ps; ++i, _r *= .9, _a += da) {
                        ...
                        var cx = x0 + r * Math.cos(_a), cy = y0 - r * Math.sin(_a), nx = x0 + r * Math.cos(_a + da),
                ...
                var c = (0, _libs.$)('<canvas width="' + this.c.width * n + '" height="' + this.c.height + '"></canvas>')[0],
                    ctx = c.getContext("2d"), t = this.calcTimeTo(this.os[1] + 2 * Math.sign(this.os[0]) * Math.PI),
                    dt = t / (n + 1), updateInterval = this.p.updateInterval;
        ...
        return LoadingController.defaultLoadingMsg = function (progress) {
            ...
            if (this.view) {
                this.view.setState("widLoadingProgress", {
                    ...
                    active: !1
                }), this.view.setState("txtLoadingProgress", {value: this.getLoadingMsg(this.progress), visible: !0});
                ...
                this.view.setState("inpPages", {visible: !0, value: ""}), this.view.setState("inpPage", {
                    visible: !0,
                    enable: !1,
                    value: ""
                })
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _EventConverter2 = __webpack_require__(6),
        _EventConverter3 = _interopRequireDefault(_EventConverter2), MouseEventConverter = function (_EventConverter) {
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _libs = __webpack_require__(0), _MathUtils = __webpack_require__(3),
        _MathUtils2 = _interopRequireDefault(_MathUtils), Object3DWatcher = function () {
            function Object3DWatcher(visual, boundBoxClb) {
                ...
                var box = this.computeClientBoundBox(), k = 1.11;
            ...
            return Object3DWatcher.prototype.movePan = function (dv) {
                ...
                var box = this.computeClientBoundBox(), Kx = this.elementSize.w / box.width,
                    Ky = this.elementSize.h / box.height;
                return 1 / Math.min(Kx, Ky)
            }, Object3DWatcher.prototype.centerView = function (T) {
                var _this = this, box = this.computeClientBoundBox(), Kx = this.elementSize.w / box.width,
                    Ky = this.elementSize.h / box.height, K = Math.min(Kx, Ky);
                ...
                var _MathUtils$rk = _MathUtils2.default.rk4(this.dy.bind(os), 0, dt, [os.vx, os.vy, os.x, os.y]),
                    vx = _MathUtils$rk[0], vy = _MathUtils$rk[1], x = _MathUtils$rk[2], y = _MathUtils$rk[3];
                return _extends({}, os, {vx: vx, vy: vy, x: x, y: y})
            }, Object3DWatcher.prototype.dy = function (t, Y) {
                var vx = Y[0], vy = Y[1], x = Y[2], y = Y[3], vd = 15, tf = this.tf(vx, vy, x, y);
        ...
        function Orbit(object, domElement) {
            ...
            _this.object = object, _this.domElement = domElement || document.body, _this.enabled = !0, _this.target = new _libs.THREE.Vector3, _this.minDistance = 0, _this.maxDistance = 1 / 0, _this.minZoom = 0, _this.maxZoom = 1 / 0, _this.minPolarAngle = 0, _this.maxPolarAngle = Math.PI, _this.minAzimuthAngle = -(1 / 0), _this.maxAzimuthAngle = 1 / 0, _this.enableDamping = !1, _this.dampingFactor = .25, _this.enableZoom = !0, _this.zoomSpeed = 1, _this.enableRotate = !0, _this.rotateSpeed = 1, _this.enablePan = !0, _this.autoRotate = !1, _this.autoRotateSpeed = 2, _this.target0 = _this.target.clone(), _this.position0 = _this.object.position.clone(), _this.zoom0 = _this.object.zoom, _this.getPolarAngle = function () {
                ...
                var offset = new _libs.THREE.Vector3,
                    ...
                    quatInverse = quat.clone().inverse(), lastPosition = new _libs.THREE.Vector3,
            ...
            var scope = _this, changeEvent = {type: "change"}, EPS = 1e-6, spherical = new _libs.THREE.Spherical,
                sphericalDelta = new _libs.THREE.Spherical, scale = 1, panOffset = new _libs.THREE.Vector3,
                zoomChanged = !1, panLeft = function () {
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _ImageBase2 = __webpack_require__(5),
        _ImageBase3 = _interopRequireDefault(_ImageBase2), _Pdf = __webpack_require__(18),
        _Pdf2 = _interopRequireDefault(_Pdf), _BaseMathUtils = __webpack_require__(2),
        _BaseMathUtils2 = _interopRequireDefault(_BaseMathUtils), _CustomEventConverter = __webpack_require__(16),
        _CustomEventConverter2 = _interopRequireDefault(_CustomEventConverter), _PolyTarget = __webpack_require__(69),
        _PolyTarget2 = _interopRequireDefault(_PolyTarget), _Finder = __webpack_require__(17),
        _Finder2 = _interopRequireDefault(_Finder), PdfImage = function (_ImageBase) {
            ...
            return _inherits(PdfImage, _ImageBase), PdfImage.prototype.setQuery = function (query) {
                ...
                return v.set(p.x, p.y, 1).transform(m), poly.push({
                    ...
                    x: v.x,
                    y: v.y
                }), v.set(p.x + s.width, p.y, 1).transform(m), poly.push({x: v.x, y: v.y}), poly
                ...
                for (var _iterator = annos, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator](); ;) {
                    ...
                    if ("Link" === anno.subtype) {
                        var rect = anno.rect, aPos = {x: rect[0], y: rect[1]}, aSz = this.rectSize(rect),
                ...
                if (this.finder) {
                    for (var testSz = (this.page.view, (0, _libs.$)('<div style="position: absolute; visibility: hidden;"></div>').appendTo("body")), textDiv = testSz[0], baseOffset = testSz.offset().left, _iterator3 = this.finder.getHits(), _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator](); ;) {
                        ...
                        var hit = _ref3, item = this.textContent.items[hit.index],
                        ...
                        var testSpan = testSz.find("span"),
                            ...
                            width = testSz.width(), relativeOffset = (testSpan.offset().left - baseOffset) / width;
                ...
                var _this5 = this;
                this.page ? this.page.render({canvasContext: this.pushCtx(), viewport: this.viewport}).then(function () {
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _ImageBase2 = __webpack_require__(5),
        _ImageBase3 = _interopRequireDefault(_ImageBase2), _Utils = __webpack_require__(4),
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _libs = __webpack_require__(0), _ImageFactory = __webpack_require__(8),
        _ImageFactory2 = _interopRequireDefault(_ImageFactory), Thumbnails = function () {
            function Thumbnails(context, container, thumbnailsClb, size) {
                var _this = this,
                    props = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {kWtoH: 210 / 297};
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _EventConverter2 = __webpack_require__(6),
        _EventConverter3 = _interopRequireDefault(_EventConverter2), TouchConverter = function (_EventConverter) {
    ...
    var _extends = Object.assign || function (target) {
        ...
        function View(parentContainer, onLoad) {
            ...
            var script = template.html ? template.script : this.getTemplate().script, urls = {
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _libs = __webpack_require__(0), _Orbit = __webpack_require__(56), _Orbit2 = _interopRequireDefault(_Orbit),
        ...
        _ThreeTouchEventConverter2 = _interopRequireDefault(_ThreeTouchEventConverter), _Drag = __webpack_require__(48),
        _Drag2 = _interopRequireDefault(_Drag), _CSS3DRenderer = __webpack_require__(12),
        _CSS3DRenderer2 = _interopRequireDefault(_CSS3DRenderer), VisualWorld = function (_THREE$EventDispatche) {
            ...
            return _inherits(VisualWorld, _THREE$EventDispatche), VisualWorld.prototype.dispose = function () {
                ...
                var _this2 = this, updateCamera = function (camera) {
                    camera.aspect = _this2.width() / _this2.height(), camera.updateProjectionMatrix()
                }, updateRenderer = function (renderer) {
                    renderer.setSize(_this2.width(), _this2.height())
                };
                updateCamera(this.camera), updateRenderer(this.renderer), updateRenderer(this.cssRenderer), this.dispatchEvent({type: "resize"})
                ...
                var vertices = bufGeometry.attributes.position.array,
                    idxVertices = indexedBufferGeom.attributes.position.array, indices = indexedBufferGeom.index.array,
                    numIdxVertices = idxVertices.length / 3, numVertices = vertices.length / 3;
                ...
                var positions = this.geometry.attributes.position.array, i = 3 * node;
    ...
    exports.__esModule = !0;
    var _Controller2 = __webpack_require__(15), _Controller3 = _interopRequireDefault(_Controller2),
    ...
    exports.__esModule = !0;
    var _Target2 = __webpack_require__(21), _Target3 = _interopRequireDefault(_Target2),
    ...
    !function (f, e) {
        ...
        return f.Panel = function (e, f, l) {
            var c = 1 / 0, k = 0, g = Math.round, a = g(window.devicePixelRatio || 1), r = 80 * a, h = 48 * a,
                t = 3 * a, v = 2 * a, d = 3 * a, m = 15 * a, n = 74 * a, p = 30 * a,
